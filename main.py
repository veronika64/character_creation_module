...
def attack(char_name: str, char_class: str) -> str:
    """
    Функция attack отвечает за расчет количества очков урона противнику.
    В зависимости от выбора класса персонажа наноситься урон случайной силы.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Функция отвечает за расчет количества очков урона здоровью."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция отвечает за изменение характеристик героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print('веди одну из команд: attack — чтобы атаковать противника,'
          'defence — чтобы блокировать атаку противника илиspecial —'
